...
shared.LoaderTitle = "Đăng Ký Kênh Days_and Roblox";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://123823386926286",
...
function CheckLevel()
    ...
    if Sea1 then
        ...
        elseif ((v197 == 10) or (v197 <= 474) or (SelectMonster == "God's Guard")) then
            ...
            if (_G.AutoLevel and ((CFrameMon.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000)) then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.ne# DAYS-AND-HUB
